(ns marketentry.store
  "SSoT for the GRC market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems GR" :portal "ESIDIS/Promitheus"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-afm? true :afm-verified? true
             :drafted? false :submitted? false
             :jurisdiction "GRC" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "ESIDIS/Promitheus"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-afm? true :afm-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "ESIDIS/Promitheus"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "GRC" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "ESIDIS/Promitheus"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? false
             :requires-afm? true :afm-verified? true
             :drafted? false :submitted? false
             :jurisdiction "GRC" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "ESIDIS/Promitheus"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-afm? true :afm-verified? false
             :drafted? false :submitted? false
             :jurisdiction "GRC" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "ESIDIS/Promitheus"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-eu-establishment? has-eu-establishment?
                               requires-afm? afm-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-eu-establishment?)  (assoc :engagement/requires-eu-establishment? requires-eu-establishment?)
    (some? has-eu-establishment?)       (assoc :engagement/has-eu-establishment? has-eu-establishment?)
    (some? requires-afm?)    (assoc :engagement/requires-afm? requires-afm?)
    (some? afm-verified?)    (assoc :engagement/afm-verified? afm-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-eu-establishment? :engagement/has-eu-establishment?
   :engagement/requires-afm? :engagement/afm-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-eu-establishment? (boolean (:engagement/requires-eu-establishment? m))
     :has-eu-establishment? (boolean (:engagement/has-eu-establishment? m))
     :requires-afm? (boolean (:engagement/requires-afm? m))
     :afm-verified? (boolean (:engagement/afm-verified? m))
